...
4. Посилання на Google диск для перегляду результату <p>4. <a href="https://drive.google.com/file/d/1yMsXqrXIsHFjBzFYCnswylbK1NLD0j-q/view?usp=sharing">Посилання на Гугл диск</a></p>

5. OneDrive для перегляду результату <p>5. <a href="https://pnpu-my.sharepoint.com/:p:/g/personal/ratushna_sv_pdpu_edu_ua/ERDQY9jlB4dHtyXOwyid6RMBZHElHX9FMcySA8_jxQPxaw?e=87UDtJ">Посилання на OneDrive</a></p>

6.1. Рідний формат для редактору Microsoft Office.

<p>6.1 <a href="lab5.pptx">Формат Microsoft (*.pptx)</a></p>

6.2. Перегляд у форматі ODP.
<p>6.2 <a href="lab5.odp">Формат Open Office (*.odp)</a></p>
